...
namespace BausparenAutomation.pageObjects
{
    public class KontaktPage
    {
        ...
        private IWebElement kontaktHeader;
        public String GetKontaktHeader()
        {
            return kontaktHeader.Text;
        }

        [FindsBy(How = How.ClassName, Using = "wizard")]
        private IWebElement kontaktForm;
        public IWebElement GetKontaktForm()
        {
            return kontaktForm;
        }
    }
